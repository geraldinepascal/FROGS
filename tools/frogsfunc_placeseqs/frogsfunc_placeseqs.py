...
class HspMarker(Cmd):
    ...
    """
    def __init__(self, output_tree, marker_type, marker_table, hsp_method, output, log):
        """
        ...
        Cmd.__init__(self,
                 ...
                 ' marker --input-tree ' + output_tree + ' --marker-type ' + marker_type + opt + ' --hsp-method ' + hsp_method + ' -o ' + output + '  2> ' + log,
                "--version")
...
if __name__ == "__main__":
    ...
    try:
        ...
        HspMarker(args.output_tree, category, args.input_marker_table, args.hsp_method, args.output_marker, tmp_hsp_marker).submit(args.log_file)

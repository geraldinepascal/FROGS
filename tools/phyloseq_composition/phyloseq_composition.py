    ...
    def __init__(self, html, phyloseq, varExp,taxaRank1,taxaSet1,taxaRank2,numberOfTaxa, rmd_stderr):
        ...
        Cmd.__init__( self,
                      ...
                      'Run 1 code Rmarkdown',
                       ...
                       "',numberOfTaxa=" + str(numberOfTaxa) + ", libdir ='" + LIBR_DIR + "', themedir ='" + THEME_DIR + "', version='"+ str(__version__) + "', tool='" + os.path.basename(__file__) + "'), intermediates_dir='" + os.path.dirname(html) + "')" + '" 2> ' + rmd_stderr,
...
if __name__ == "__main__":
    ...
    group_output.add_argument('--html', default='phyloseq_composition.nb.html', help="The HTML file containing the graphs. [Default: %(default)s]" )

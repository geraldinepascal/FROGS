...
```
<h3>FROGS Phyloseq: Import Data (version 3.2)</h3>

 Phyloseq `r packageVersion("phyloseq")`
 
```{r package_import, code_folding="hide", message=FALSE, warning=FALSE}
library(phyloseq)
library(ggplot2)
#library(biom)
library(ape)
...
# import was done using parse_taxonomy_greengenes function
# user taxonomic rank names are ignored

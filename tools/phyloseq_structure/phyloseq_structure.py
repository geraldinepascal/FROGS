    ...
    def __init__(self, html, phyloseq, varExp, method, distance, rmd_stderr):
        ...
        Cmd.__init__( self,
                      ...
                      'Run 1 code Rmarkdown',
                       ...
                       "', params=list(phyloseq='" + phyloseq + "', varExp='" + varExp + "',method='" + method + "',distance='" + distance + "', libdir ='" + LIBR_DIR + "', themedir ='" + THEME_DIR + "', version='"+ str(__version__) + "', tool='" + os.path.basename(__file__) + "'), intermediates_dir='" + os.path.dirname(html) + "')" + '" 2> ' + rmd_stderr,

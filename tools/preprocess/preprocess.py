    ...
    def __init__(self, in_R1, in_R2, out_prefix, log, param):
        ...
        Cmd.__init__(self,
            ...
            'join overlapping paired reads',
             ...
             + ' --fastq_allowmergestagger --fastq_ascii ' + param.quality_scale + ' --fastq_maxdiffs ' + str(max_diff) + ' --fastq_maxdiffpct ' + str(param.mismatch_rate) + ' --fastq_minovlen ' + str(min_overlap) \
             + ' 2> ' + log,
             '--version')

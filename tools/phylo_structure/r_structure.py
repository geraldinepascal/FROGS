    ...
    def __init__(self, html, phyloseq, varExp, method, distance, rmd_stderr):
        ...
        Cmd.__init__( self,
                      ...
                      'Run 1 code Rmarkdown',
                       ...
                       "', params=list(phyloseq='" + phyloseq + "', varExp='" + varExp + "',method='" + method + "',distance='" + distance + "', libdir ='" + LIBR_DIR + "'), intermediates_dir='" + os.path.dirname(html) + "')" + '" 2> ' + rmd_stderr,
...
if __name__ == "__main__":
    ...
    group_output.add_argument('-o','--html', default='structure.nb.html', help="path to store resulting notebook html file : .nb.html [Default: %(default)s]" )

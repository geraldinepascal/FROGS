...
input_over <- paste(dir_name, "/over_functions.tsv", sep="")
input_under <- paste(dir_name, "/under_functions.tsv", sep="")
...
### Differentially abundant functions colored in ipath3. Over (greens) and under (reds) abundants.
```

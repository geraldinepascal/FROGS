...
```
```{r doc_path, echo=run_ipath}
# Import input files
doc <- paste0("The first image (green paths) represents the over-abundants involved pathways in ", params$mod1 ," condition. The second image (red paths) represents the under-abundant pathways in ", params$mod1, " condition.
The darker the path, the higher the log2 fold change (>0, >3, >6, >9 or >12).

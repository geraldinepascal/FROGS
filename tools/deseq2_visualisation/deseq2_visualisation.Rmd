...
The first image (green paths) represents the over-abundants involved pathways related to DESeq2 results. The second image (red paths) represents the under-abundant pathways.

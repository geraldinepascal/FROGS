...
if(length(result_names) == 2 || params$mod1 == "None"){
     ...
     doc <- paste("You choose to compare ", params$mod2, " to the reference modality ", params$mod1, ". This implies that a positive log2FoldChange means more abundant in ", params$mod2, " than in ", params$mod1, ".", sep="")
     cat(doc)
}
```

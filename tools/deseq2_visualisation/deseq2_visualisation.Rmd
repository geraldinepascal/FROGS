...
## Differentially abundant ASV/FUNC table
...
Then we extract significant ASVs or FUNCs at the p-value adjusted threshold (after Benjamini Hochberg correction) and enrich results with taxonomic/functional classification and sort the results by pvalue.
...
Pie <- ggplot(da_pie, aes(x="", y=Number, fill=IDs)) + 
           ...
           labs(x = NULL, y = NULL, fill = NULL, title = "Pie chart to view ASVs or FUNCs number of Differential Abundance test") +
           theme_classic() + theme(
...
cat("There are no differentially abundant ASVs or FUNCs. Please use a higher threshold for the adjusted p-value or consider a different comparison.")
```

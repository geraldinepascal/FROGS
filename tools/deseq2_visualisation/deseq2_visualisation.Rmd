---
title: "FROGSSTAT DESeq2: Visualisation (version 3.2.2)"
output: 
  html_notebook:
    code_folding: hide
params:
...
if(length(result_names) == 2 || params$mod1 == "None"){
     ...
     doc <- paste("You choose to compare ", params$mod2, " to the reference modality ", params$mod1, ". This implies that a positiv log2FoldChange means more abundant in ", params$mod2, " than in ", params$mod1, ".", sep="")
     cat(doc)
}
```
...
#8EADAC : bleu claire
#DE9F73 : orange claire

#759493 : bleu foncé (10%)
#C6792B : orange foncé

...
<div style="display:flex; align-items:center; gap:15px; margin-bottom:20px;">
  ...
  <h1 style="margin:0;">Stat: Sample clustering using different linkage method<i><span class="text-accent">(`r params$tool` v`r params$version`)</span></i></h1>
</div>
...
## Ward D2
```{r ward, fig.width=10, fig.height=7, echo=FALSE}
plot_clust(data, dist, method = "ward.D2", color = params$varExp)
```

## Complete
```{r complete, fig.width=10, fig.height=7, echo=FALSE}
plot_clust(data, dist, method = "complete", color = params$varExp)
```

## Single
```{r single, fig.width=10, fig.height=7, echo=FALSE}

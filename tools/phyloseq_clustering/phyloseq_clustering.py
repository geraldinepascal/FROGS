    ...
    def __init__(self, html, phyloseq, varExp, distance,rmd_stder):
        ...
        Cmd.__init__( self,
                      ...
                      'Run 1 code Rmarkdown',
                       ...
                       "', params=list(phyloseq='" + phyloseq + "', varExp='" + varExp + "',distance='" + distance + "', libdir ='" + LIBR_DIR + "', tool='" + os.path.basename(__file__) + "'), intermediates_dir='" + os.path.dirname(html) + "')" + '" 2> ' + rmd_stderr,
...
if __name__ == "__main__":
    ...
    group_output.add_argument('--html', default='phyloseq_clustering.nb.html', help="The HTML file containing the graphs. [Default: %(default)s]" )   
    ...
    try:
        ...
        Rscript(html, phyloseq, args.var_exp, distance,rmd_stderr).submit( args.log_file )
    finally :
        if not args.debug:
            tmpFiles.deleteAll()

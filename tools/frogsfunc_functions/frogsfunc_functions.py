...
if __name__ == "__main__":
	...
	group_input_16S.add_argument('-f', '--functions', default="EC", help="Specifies which function databases should be used (%(default)s). EC is used by default because necessary for frogsfunc_pathways. At least EC or KO is required. To run the command with several functions, separate the functions with commas (ex: -i EC,PFAM).")
	...
	if args.marker_type == "16S":
		functions = check_functions(args.functions)

...
def write_summary(in_fasta, align_out, biomfile, closest_ref_file, category, summary_file):
	...
	details_categorys =["FROGS Taxonomy","Picrust2 closest ID","Picrust2 closest reference name","Picrust2 closest taxonomy","Picrust2 closest distance from cluster (NSTI)","Lowest same taxonomic rank between FROGS and Picrust2","Comment"]
	infos_otus = list()

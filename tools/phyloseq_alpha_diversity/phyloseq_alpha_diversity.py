    ...
    def __init__(self, phyloseq, html, varExp, measures, alphaOut, rmd_stderr):
        ...
        Cmd.__init__( self,
                      ...
                      'Run 1 code Rmarkdown',
                       ...
                       "', params=list(phyloseq='" + phyloseq + "', measures='" + measures + "', varExp='" + varExp + "',fileAlpha='" + alphaOut + "', libdir ='" + LIBR_DIR + "', themedir ='" + THEME_DIR + "', version='"+ str(__version__) + "', tool='" + os.path.basename(__file__) + "'), intermediates_dir='" + os.path.dirname(html) + "')" + '" 2> ' + rmd_stderr,

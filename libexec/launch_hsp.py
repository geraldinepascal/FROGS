...
if __name__ == "__main__":
    ...
    group_output_marker.add_argument('-l', '--log-file', default=sys.stdout, help='List of commands executed.')
    ...
    group_output_function.add_argument('--output-dir', help='Output directory for function predictions.')

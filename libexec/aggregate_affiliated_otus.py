...
if __name__ == "__main__":
    ...
    parser.add_argument( '-i', '--identity', default=90.0, type=float, help="Min percentage identity to agggregate OTU. [Default: %(default)s]")
    parser.add_argument( '-c', '--coverage', default=90.0, type=float, help="Min percentage coverage to agggregate OTU. [Default: %(default)s]")
